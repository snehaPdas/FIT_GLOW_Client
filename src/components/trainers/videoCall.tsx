...
import {setRoomId,setShowVideoCall,setVideoCall} from "../../features/trainer/TrainerSlice"
...
function TrainerVideoCall() {
    ...
    const {roomIdTrainer,videoCall}=useSelector((state:RootState)=>state.trainer)
